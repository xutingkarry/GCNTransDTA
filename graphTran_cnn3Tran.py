...
class GraphTransformer(nn.Module):
    def __init__(self, in_size=78, num_class=2, d_model=128, num_heads=8,
        ...
        self.cnn_attn = TransformerEncoder(d_model=128, n_head=8, nlayers=4)

        self.p_fc1 = nn.Linear(121, 128)
    ...
    def forward(self, data, return_attn=False):
        ...
        protein = self.cnn_attn(protein)

        # flatten
        protein = protein.view(-1, 32 * 128)
